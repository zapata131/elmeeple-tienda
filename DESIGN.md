...
*   **Edition Language Badges & Vector Pill Tags (US-33, Issue #36):** Comparison tables (`StoreOffersComparisonTable.tsx`) replace raw language text/flags with high-contrast, brand-styled typographic badge components (`renderEditionBadge`) displaying standardized edition markers (`ES · Español`, `PT · Português`, `EN · English`, `DE · Deutsch`, `MULTI · Multi-*   **Vector SVG Icons & Complete Emoji Ban (US-34, Issue #37):** All user-facing interfaces (`page.tsx`, `Toolbar.tsx`, `StoreOffersComparisonTable.tsx`, and `UserAlertsDashboard.tsx`) completely eradicate raw unicode emojis (`🎲`, `🔥`, `🌍`, `💸`, `📦`, `🇪🇸`, `🇵🇹`, `🇬🇧`, `🇩🇪`, `🌐`, `🏪`, `🛡️`, `ℹ️`, `✨`, `⚠️`, `🔔`, `⏳`, `⚡`). They are replaced by crisp vector SVG icons and styled typographic pill labels colored using official brand tokens (`#8367C7` Malva, `#73D8D4` Turquesa, `#FF9E8A` Coral).
