...
*   **Navbar Navigation & Brand Identity (US-30, Issue #33):** Responsive navigation header (`Toolbar.tsx`) rendering clean SVG vector icons, streamlined role switcher pills (`Comprador`, `Tienda`, `Admin`), and persistent brand branding (`MeeplePrecios`).
